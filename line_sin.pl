...
my $input_datafile = 'area.txt'; # your input data file for plotting
my $output_file = 'area.png'; # your output file for plotting
my $plotTitle = 'time = 0 sec.';
my $x_labelName = 'km';
my $y1_labelName = 'money';
my $y1_legend = 'profile';
